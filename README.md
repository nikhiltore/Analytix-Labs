...
4.	Understand consumer dissatisfaction through dispute rates.
...
•	Visual report in Report_Task1
🔹 Task 2: Timely Response Performance
•	% of timely responses
•	Comparison across companies
•	Highlighting companies with lower service quality
🔹 Task 3: Resolution Time Analysis
•	Average resolution days
•	Long-duration complaint identification
•	Summary provided in Report_Task3
🔹 Task 4: Consumer Dispute Analysis
•	Dispute rate by company and product
•	Understanding customer dissatisfaction patterns
•	Report stored in Report_Task4
🔹 Task 5: Quarterly Trend Analysis
...
•	Formulas
o	COUNTIFS, SUMIFS, AVERAGEIFS, IF, DATEDIF
•	Pivot Tables
o	Summary tables for all tasks
•	Pivot Charts
o	For visual insights
•	Lookup Functions
o	VLOOKUP / XLOOKUP
•	Dashboarding
